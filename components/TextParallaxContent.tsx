...
const StickyImage: React.FC<{ imgUrl: string }> = ({ imgUrl }) => {
  const IMG_PADDING = 12; // Moved inside the component scope
...
interface OverlayCopyProps {
  ...
  const OverlayCopy: React.FC<OverlayCopyProps> = ({ heading, subheading }) => {
    ...
    return (
      <motion.div ref={targetRef} style={{y, opacity}} className='absolute left-0 top-0 flex h-screen w-full flex-col items-center justify-center text-white'>
...
const TextParallaxContentExample: React.FC = () => {
  return (
    <div className='bg-white'>
      <TextParallaxContent 
        imgUrl="https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=2920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
